                    ...
                    <tr>
                        {tableItems.map((item) => (
                            ...
                            >
                                <div
                                    className={
                                        styles.usersTableThHeaedContainer
                                    }
                                >
                                    {item.title}
                                    {soringKey === item.name ? (
                        ...
                        filteredUsers?.map((user) => (
                            <tr key={user.id}>
                                ...
                                >
                                    <div
                                        className={
                                            styles.userTableActionsContainer
                                        }
                                    >
                                        <div
                                            className={
                                                styles.deleteUserContainer
                                            }
                                        >
                                            <MdDeleteForever
                                                size={24}
                ...
                <form method="dialog">
                    {confirmDelete && (
                        <ConfirmModal
                            userId={deleteUserId!}
                            onConfirmHandler={() =>
                                onDeleteUserHandler(deleteUserId!)
                            }
